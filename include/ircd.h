 ...
 * "ircd.h". - Headers file.
 *
 * $Id: ircd.h,v 1.6 2005/08/27 16:23:49 jpinto Exp $
 *
 */
...
extern char*          serno;
extern char*          ircdversion;
extern char	      	  ircdpath[];
...
extern int            dorehash;
extern int            rehashed;
extern float      	  currlife, cursend;
extern struct Client  me;
extern struct Client* GlobalClientList;
extern struct Client* local[];
extern struct Counter Count;
extern time_t         CurrentTime;
extern int            ircntp_offset;
extern time_t         LCF;
extern time_t         nextconnect;
extern time_t         nextping;
extern int            no_ssl;
extern int            secure_mode;
extern int	      services_on;
extern int            debug_opt;
extern char*          ajoin_chans[5];
extern int            hvc_enabled;

#ifdef HLC
/* these are for HLC --fabulous */
extern int            sentping;
extern time_t         receivedat;
extern void           resetHLC(void);
#endif
