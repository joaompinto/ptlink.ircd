 ...
 *
 *   $Id: irc_string.h,v 1.3 2005/08/27 16:23:49 jpinto Exp $
 */
...
/*
 * return total seconds count fro time string
 */
extern int time_str(char *timestr);
...
extern char* strip_control_codes(char *text);
extern char* strip_control_codes_lower(char *text);
extern void parse_multi(const char *multi, char* delim, char **items, int maxitems);
...
#else
#define IsNickChar(c)   (CharAttrs[(unsigned char)(c)] & (NICK_C | HANGUL_C))
#endif
...
#ifdef  KOREAN
#define IsHangul(c) (CharAttrs[(unsigned char)(c)] & HANGUL_C)
#endif 
