/*
 * setup.c: $Id: setup.c,v 1.4 2005/08/27 16:23:49 jpinto Exp $
 *  
 */
/*
 * setup.c
...
#endif 
static int readconfig(adns_state ads, const char *filename, int warnmissing);
...
#ifdef __CYGWIN__
  if(readconfig(ads,"resolv.conf",1) == -1)
      return -1;
#else
